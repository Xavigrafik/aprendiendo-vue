  ...
  <section class="contenedor-aprendizaje">
    ...
    <main class="panel-control">
      ...
      <div class="info-adicional">
        ...
        <p v-if="esNumeroAlto" class="mensaje-aviso">⚠️ Has superado la decena</p>
      </div>

      <nav class="acciones">
        <button @click="incrementar" class="btn-principal">Incrementar</button>
        <button @click="resetear" class="btn-secundario">Resetear</button>
      </nav>
    </main>
...
.contenedor-aprendizaje {
  ...
  .acciones {
    ...
    .btn-principal { background: #42b883; color: white; }
    .btn-secundario { background: #35495e; color: white; }
  }
  ...
  .formulario-edicion {
    ...
    label { display: block; margin-bottom: 8px; font-size: 0.8rem; }
    input {
      width: 100%;
      padding: 8px;
